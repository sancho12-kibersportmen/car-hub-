...
const SearchManufacture = ({ manufacturer, 
    setManufacturer }: SearchManufactureProps ) => {
      ...
      {setManufacturer}>
        <div className="relative w-full">
          ...
          <Combobox.Input
            ...
            placeholder="Toyota"
            displayValue={(manufacturer: string) => manufacturer ? capitalizeFirstLetter(manufacturer) : ""}
